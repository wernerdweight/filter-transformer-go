...
var testOutputElastic0, _ = contract.NewInputOutputType(map[string]any{"bool": map[string]any{"must": []map[string]any{{"term": map[string]any{"key": "val"}}}}}, &output.ElasticOutput{})
var testOutputElastic1, _ = contract.NewInputOutputType(map[string]any{"bool": map[string]any{"must": []map[string]any{{"bool": map[string]any{"should": []map[string]any{{"term": map[string]any{"key": "val"}}, {"bool": map[string]any{"must_not": []map[string]any{{"term": map[string]any{"key2": "val2"}}}}}}}}}}}, &output.ElasticOutput{})
...
var testOutputElastic4, _ = contract.NewInputOutputType(map[string]any{"bool": map[string]any{"should": []map[string]any{{"bool": map[string]any{"must": []map[string]any{{"term": map[string]any{"key": "val"}}, {"exists": map[string]any{"field": "key2"}}}}}, {"bool": map[string]any{"must": []map[string]any{{"match": map[string]any{"key3": "val3"}}, {"range": map[string]any{"key4": map[string]any{"gt": 123.0}}}}}}}}}, &output.ElasticOutput{})
