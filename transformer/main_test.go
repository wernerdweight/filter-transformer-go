...
var testOutputElastic1, _ = contract.NewInputOutputType(map[string]any{"bool": map[string]any{"must": []map[string]any{{"bool": map[string]any{"should": []map[string]any{{"term": map[string]any{"key": "val"}}}, "should_not": []map[string]any{{"term": map[string]any{"key2": "val2"}}}}}}}}, &output.ElasticOutput{})
